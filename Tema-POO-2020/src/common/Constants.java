...
public final class Constants {
    ...
    public static final String NO_USER = "No user found with that username";
    public static final String RES_STANDARD = "StandardRecommendation result: ";
    public static final String RES_BEST_UNSEEN = "BestRatedUnseenRecommendation result: ";
    public static final String RES_POPULAR = "PopularRecommendation result: ";
    public static final String RES_FAVORITE = "FavoriteRecommendation result: ";
    public static final String RES_SEARCH = "SearchRecommendation result: ";
    public static final String NO_STANDARD = "StandardRecommendation cannot be applied!";
    public static final String NO_BEST_UNSEEN = "BestRatedUnseenRecommendation cannot be applied!";
    public static final String NO_POPULAR = "PopularRecommendation cannot be applied!";
    public static final String NO_FAVORITE = "FavoriteRecommendation cannot be applied!";
    public static final String NO_SEARCH = "SearchRecommendation cannot be applied!";
